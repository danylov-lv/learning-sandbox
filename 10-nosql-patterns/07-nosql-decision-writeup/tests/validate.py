"""Validator for 07-nosql-decision-writeup.
...
# At least MIN_GROUNDING_HITS of these must show up SOMEWHERE in the document
# -- proof the positions are tied to what tasks 01-06 actually built/measured,
...
MIN_GROUNDING_HITS = 6

PLACEHOLDER_MARKER = "[fill in"

MIN_SECTION_CONTENT = 200  # minimum chars of actual content per section
MIN_NOTES_CONTENT = 150    # minimum chars of actual content in NOTES.md
...
def check_grounding(text):
    """The whole document must reference at least MIN_GROUNDING_HITS distinct
    concepts from the module, so the decisions are tied to what was actually
    built/measured in tasks 01-06."""
