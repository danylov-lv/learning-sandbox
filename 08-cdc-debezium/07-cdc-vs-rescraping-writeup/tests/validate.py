"""Validator for 07-cdc-vs-rescraping-writeup.
...
REQUIRED_KEYWORDS = {
    "replication_slot_wal": ["replication slot", "wal"],
    "snapshot": ["snapshot"],
    "latency": ["latency", "freshness", "staleness"],
    "backfill": ["backfill"],
    "schema_evolution": ["schema evolution"],
    "tombstone_delete": ["tombstone", "delete"],
    "idempotent_exactly_once": ["idempotent", "exactly-once"],
    "overkill_polling": ["overkill", "re-scrape", "polling"],
}
