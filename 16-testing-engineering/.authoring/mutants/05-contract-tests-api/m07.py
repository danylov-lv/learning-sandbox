"""BUG: the 404 error body is a bare `{"detail": "..."}` (FastAPI's
default shape) instead of the documented `{"error": {"code", "message"}}`
envelope -- a consumer parsing `body["error"]["code"]` gets a `KeyError`.
"""
