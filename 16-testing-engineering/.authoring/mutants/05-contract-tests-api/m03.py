"""BUG: `next_cursor` is still a non-null string on the LAST page (the
"has more" check was dropped) -- a consumer walking cursors gets an extra
spurious round-trip and can never tell from `next_cursor` alone that the
page it just received was the last one.
"""
