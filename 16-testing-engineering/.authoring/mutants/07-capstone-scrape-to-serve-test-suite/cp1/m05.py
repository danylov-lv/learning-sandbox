"""MUTANT -- normalize_record no longer collapses internal whitespace runs in the title -- it only strips leading/trailing whitespace, so 'Foo   Bar' stays 'Foo   Bar' instead of becoming 'Foo Bar'.
