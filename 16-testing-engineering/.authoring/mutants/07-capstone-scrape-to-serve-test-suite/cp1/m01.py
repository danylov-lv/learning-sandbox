"""MUTANT -- parse_price treats '.' as the thousands separator and ',' as the decimal separator (swapped from the documented grammar), so '$1,234.56' parses as 1.23456 instead of 1234.56.
