"""MUTANT -- normalize_record no longer treats 'title' as a required key -- a record missing 'title' silently gets an empty title instead of raising KeyError.
