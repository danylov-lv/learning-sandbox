"""MUTANT -- CatalogRepo.load_incremental uses 'updated_at >= %s' instead of 'updated_at > %s', so a row whose updated_at exactly equals the watermark is returned again instead of being excluded.
