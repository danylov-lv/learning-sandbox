"""MUTANT -- CatalogRepo.page uses 'id >= %s' instead of 'id > %s' for the 'after' cursor on any page past the first, so the last row of the previous page is duplicated as the first row of the next page.
