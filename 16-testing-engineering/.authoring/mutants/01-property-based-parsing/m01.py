"""BUG: _extract_currency's result is ignored -- parse_price always
returns "USD" as the currency, no matter what symbol or ISO code was
actually present in the input (e.g. EUR/GBP/JPY prices are silently
mislabeled as USD).
"""
