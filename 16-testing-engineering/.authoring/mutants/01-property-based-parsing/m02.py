"""BUG: when both "." and "," appear in the amount, the decimal/
thousands separator choice is hardcoded to the US convention (dot=
decimal, comma=thousands) instead of picking whichever separator
appears LAST in the string. European-style prices such as
"EUR 1.234,56" are parsed to the wrong value.
"""
