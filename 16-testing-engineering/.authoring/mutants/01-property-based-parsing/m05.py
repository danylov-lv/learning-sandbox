"""BUG: the parsed amount is quantized down to a whole number (cents are
dropped) before being returned, so "$19.99" comes back as 20 (or 19,
depending on rounding mode) instead of 19.99.
"""
