"""BUG: parse_price swallows ParseError from amount parsing and returns
None instead of letting the exception propagate -- malformed input
(garbage amounts, multiple decimal points, stray characters) silently
produces None rather than raising ParseError.
"""
