"""BUG: the ISO currency code extracted from the start of the input is
stored in its original case instead of being normalized to uppercase,
so e.g. "usd 99.99" produces currency "usd" instead of "USD".
"""
